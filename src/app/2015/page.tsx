  ...
  return (
    <WorkSeriesDetail
      ...
      heroImage={{
        ...
        caption: loc('밤의 숲 · 194×72(cm), 캔버스에 아크릴릭, 2020', NEEDS_TRANSLATION),
      }}
      images={[
        {
          ...
          alt: '숨어있던 꽃',
          orientation: 'landscape',
          caption: loc('숨어있던 꽃 · 80×232(cm), 캔버스에 아크릴릭, 2018, 2023', NEEDS_TRANSLATION),
        },
        {
          src: '/images/2015/thoughtful-consolation.jpeg',
          alt: '사려깊은 위로',
          orientation: 'landscape',
          caption: loc('사려깊은 위로 · 162×336(cm), 캔버스에 아크릴릭, 2022', NEEDS_TRANSLATION),
        },
        {
          src: "/images/2015/seems-like-doesn't-exist.png",
          alt: '없는 듯 있다',
          orientation: 'landscape',
          caption: loc('없는 듯 있다 · 60x169cm, 캔버스에 아크릴릭, 2018', NEEDS_TRANSLATION),
        },
        {
          src: '/images/2015/neighborhood.png',
          alt: '동네',
          orientation: 'landscape',
          caption: loc('동네 · 162×336(cm), 캔버스에 아크릴릭, 2022', NEEDS_TRANSLATION),
        },
        {
          src: '/images/2015/inside-the-blue-alley.jpg',
          alt: '푸른 골목의 안쪽',
          orientation: 'landscape',
          caption: loc('푸른 골목의 안쪽 · 155x95(cm), 캔버스에 아크릴릭, 2021', NEEDS_TRANSLATION),
        },
        {
