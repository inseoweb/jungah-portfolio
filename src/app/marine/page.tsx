export default function marine() {
    return (
      <main className="px-6 py-12 max-w-6xl mx-auto">
        {/* 제목 */}
        <h1 className="text-[14px] font-semibold text-center text-[#666666] mb-1">[ 2011~ ]<br /></h1>
        <h1 className="text-xl font-bold text-center mb-3">해양환경작품</h1>
  
        {/* 본문 서문 */}
        <p className="text-left leading-relaxed mb-12 text-[#666666] max-w-2xl mx-auto">
        2011년 바다 오염으로 고통받는 생물에 대한 연구를 접한 이후부터 바다쓰레기를 줍고 조사, 분류하며 바다 환경오염의 심각성을 알리는 창작 작업과 전시를 해오고 있다.<br/><br/>
        바다쓰레기 문제에 대해 연구하는 동아시아바다공동체 오션에서 예술 감독으로 함께 활동하며 해양오염 문제연 구 발표와 정책수립을 위한 전시, 학생과 환경교육 강사 에게 강연을 해오고 있다. 우리나라가 앞서서 해양쓰레 기 문제에 깊은 관심을 갖고 연구해 왔기에 제7차 국제 해양폐기물 컨퍼런스가(유엔환경계획 주최) 미국외의 국가 중 최초로 한국에서 열리게 되었고 여기서 전시기획 과함께 hug me -돌아온 탕아를 선보였다.<br/><br/>
        해양쓰레기 문제가 각 나라들만의 문제가 아닌 전세계 가 함께 풀어야하는 문제임을 인식하고 쓰레기 문제 해 결을 위해 우리가 해온 모니터링 방법을 알려주는 국제 프로그램에서 필리핀 정부관계자들에게 바다를 지키기 위해 예술로 할 수있는 노력을 보여주는 강연을 하는 등 예술이 해양 보존, 정책 변화, 미래세대 교육을 위해 무 엇을 할 수있을지에 큰 관심을 가지고 활동하고 있다.
        </p>
        ...
        <div className="pb-[80px]">
          ...
          <div className="flex justify-center items-center space-x-[15px]">
            <span className="text-[16px] font-bold text-[#111827]">Dinner 2011</span>
        ...
        <div className="pb-[80px]">
          <img
            ...
            className="w-[90%] h-auto mx-auto mb-[20px]"        />
          <div className="flex justify-center items-center space-x-[15px]">
            <span className="text-[16px] font-bold text-[#111827]">Hug me - 돌아온 탕아</span>
            <span className="text-[16px] font-normal text-[#4B5563]">
