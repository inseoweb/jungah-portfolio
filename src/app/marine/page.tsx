  ...
  return (
    <main className="px-6 py-12 max-w-6xl mx-auto">
      ...
      <p className="text-center leading-relaxed mb-12 text-[#666666] text-[15px] sm:text-base max-w-full sm:max-w-2xl mx-auto px-0 sm:px-0">
        ...
        <br />
        <br />
        바다쓰레기 문제에 대해 연구하는 동아시아바다공동체 오션에서 예술 감독으로 함께 활동하며 해양오염 문제연구 발표와
        정책수립을 위한 전시, 학생과 환경교육 강사에게 강연을 해오고 있다. 우리나라가 앞서서 해양쓰레기 문제에 깊은
        관심을 갖고 연구해 왔기에 제7차 국제 해양폐기물 컨퍼런스가 (유엔환경계획 주최) 미국 외의 국가 중 최초로 한국에서
        열리게 되었고 여기서 전시기획과 함께 hug me-돌아온 탕아를 선보였다.
        <br />
        <br />
        해양쓰레기 문제가 각 나라들만의 문제가 아닌 전세계가 함께 풀어야하는 문제임을 인식하고 쓰레기 문제 해결을 위해
        우리가 해온 모니터링 방법을 알려주는 국제 프로그램에서 필리핀 정부 관계자들에게 바다를 지키기 위해 예술로 할 수
        있는 노력을 보여주는 강연을 하는 등 예술이 해양 보존, 정책 변화, 미래세대 교육을 위해 무엇을 할 수 있을지에 큰
        관심을 가지고 활동하고 있다.
      </p>
